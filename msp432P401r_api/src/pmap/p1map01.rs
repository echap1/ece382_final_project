...
pub type R = crate::R<P1map01Spec>;
#[doc = "Register `P1MAP01` writer"]
pub type W = crate::W<P1map01Spec>;
...
impl W {
    #[doc = "Bits 0:15 - Selects secondary port function"]
    #[inline(always)]
    pub fn pmapx(&mut self) -> PmapxW<P1map01Spec> {
        PmapxW::new(self, 0)
    }
}
#[doc = "Port mapping register, P1.0 and P1.1\n\nYou can [`read`](crate::Reg::read) this register and get [`p1map01::R`](R). You can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p1map01::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P1map01Spec;
impl crate::RegisterSpec for P1map01Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`p1map01::R`](R) reader structure"]
impl crate::Readable for P1map01Spec {}
#[doc = "`write(|w| ..)` method takes [`p1map01::W`](W) writer structure"]
impl crate::Writable for P1map01Spec {
