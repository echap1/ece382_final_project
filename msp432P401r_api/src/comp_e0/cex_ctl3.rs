...
pub type R = crate::R<CexCtl3Spec>;
#[doc = "Register `CExCTL3` writer"]
pub type W = crate::W<CexCtl3Spec>;
#[doc = "Port disable\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bit 0 - Port disable"]
    #[inline(always)]
    pub fn cepd0(&mut self) -> Cepd0W<CexCtl3Spec> {
        Cepd0W::new(self, 0)
    }
    #[doc = "Bit 1 - Port disable"]
    #[inline(always)]
    pub fn cepd1(&mut self) -> Cepd1W<CexCtl3Spec> {
        Cepd1W::new(self, 1)
    }
    #[doc = "Bit 2 - Port disable"]
    #[inline(always)]
    pub fn cepd2(&mut self) -> Cepd2W<CexCtl3Spec> {
        Cepd2W::new(self, 2)
    }
    #[doc = "Bit 3 - Port disable"]
    #[inline(always)]
    pub fn cepd3(&mut self) -> Cepd3W<CexCtl3Spec> {
        Cepd3W::new(self, 3)
    }
    #[doc = "Bit 4 - Port disable"]
    #[inline(always)]
    pub fn cepd4(&mut self) -> Cepd4W<CexCtl3Spec> {
        Cepd4W::new(self, 4)
    }
    #[doc = "Bit 5 - Port disable"]
    #[inline(always)]
    pub fn cepd5(&mut self) -> Cepd5W<CexCtl3Spec> {
        Cepd5W::new(self, 5)
    }
    #[doc = "Bit 6 - Port disable"]
    #[inline(always)]
    pub fn cepd6(&mut self) -> Cepd6W<CexCtl3Spec> {
        Cepd6W::new(self, 6)
    }
    #[doc = "Bit 7 - Port disable"]
    #[inline(always)]
    pub fn cepd7(&mut self) -> Cepd7W<CexCtl3Spec> {
        Cepd7W::new(self, 7)
    }
    #[doc = "Bit 8 - Port disable"]
    #[inline(always)]
    pub fn cepd8(&mut self) -> Cepd8W<CexCtl3Spec> {
        Cepd8W::new(self, 8)
    }
    #[doc = "Bit 9 - Port disable"]
    #[inline(always)]
    pub fn cepd9(&mut self) -> Cepd9W<CexCtl3Spec> {
        Cepd9W::new(self, 9)
    }
    #[doc = "Bit 10 - Port disable"]
    #[inline(always)]
    pub fn cepd10(&mut self) -> Cepd10W<CexCtl3Spec> {
        Cepd10W::new(self, 10)
    }
    #[doc = "Bit 11 - Port disable"]
    #[inline(always)]
    pub fn cepd11(&mut self) -> Cepd11W<CexCtl3Spec> {
        Cepd11W::new(self, 11)
    }
    #[doc = "Bit 12 - Port disable"]
    #[inline(always)]
    pub fn cepd12(&mut self) -> Cepd12W<CexCtl3Spec> {
        Cepd12W::new(self, 12)
    }
    #[doc = "Bit 13 - Port disable"]
    #[inline(always)]
    pub fn cepd13(&mut self) -> Cepd13W<CexCtl3Spec> {
        Cepd13W::new(self, 13)
    }
    #[doc = "Bit 14 - Port disable"]
    #[inline(always)]
    pub fn cepd14(&mut self) -> Cepd14W<CexCtl3Spec> {
        Cepd14W::new(self, 14)
    }
    #[doc = "Bit 15 - Port disable"]
    #[inline(always)]
    pub fn cepd15(&mut self) -> Cepd15W<CexCtl3Spec> {
        Cepd15W::new(self, 15)
    }
}
#[doc = "Comparator Control Register 3\n\nYou can [`read`](crate::Reg::read) this register and get [`cex_ctl3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cex_ctl3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CexCtl3Spec;
impl crate::RegisterSpec for CexCtl3Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`cex_ctl3::R`](R) reader structure"]
impl crate::Readable for CexCtl3Spec {}
#[doc = "`write(|w| ..)` method takes [`cex_ctl3::W`](W) writer structure"]
impl crate::Writable for CexCtl3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets CExCTL3 to value 0"]
impl crate::Resettable for CexCtl3Spec {
