...
pub type R = crate::R<CexCtl1Spec>;
#[doc = "Register `CExCTL1` writer"]
pub type W = crate::W<CexCtl1Spec>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Off"]
    #[inline(always)]
    pub fn ceon_0(self) -> &'a mut crate::W<REG> {
        self.variant(Ceon::Ceon0)
    }
    #[doc = "On"]
    #[inline(always)]
    pub fn ceon_1(self) -> &'a mut crate::W<REG> {
        self.variant(Ceon::Ceon1)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "VREF0 is selected if CERS = 00, 01, or 10"]
    #[inline(always)]
    pub fn cemrvl_0(self) -> &'a mut crate::W<REG> {
        self.variant(Cemrvl::Cemrvl0)
    }
    #[doc = "VREF1 is selected if CERS = 00, 01, or 10"]
    #[inline(always)]
    pub fn cemrvl_1(self) -> &'a mut crate::W<REG> {
        self.variant(Cemrvl::Cemrvl1)
    }
}
...
impl W {
    #[doc = "Bit 0 - Comparator output value"]
    #[inline(always)]
    pub fn ceout(&mut self) -> CeoutW<CexCtl1Spec> {
        CeoutW::new(self, 0)
    }
    #[doc = "Bit 1 - Comparator output polarity"]
    #[inline(always)]
    pub fn ceoutpol(&mut self) -> CeoutpolW<CexCtl1Spec> {
        CeoutpolW::new(self, 1)
    }
    #[doc = "Bit 2 - Comparator output filter"]
    #[inline(always)]
    pub fn cef(&mut self) -> CefW<CexCtl1Spec> {
        CefW::new(self, 2)
    }
    #[doc = "Bit 3 - Interrupt edge select for CEIIFG and CEIFG"]
    #[inline(always)]
    pub fn ceies(&mut self) -> CeiesW<CexCtl1Spec> {
        CeiesW::new(self, 3)
    }
    #[doc = "Bit 4 - Input short"]
    #[inline(always)]
    pub fn ceshort(&mut self) -> CeshortW<CexCtl1Spec> {
        CeshortW::new(self, 4)
    }
    #[doc = "Bit 5 - Exchange"]
    #[inline(always)]
    pub fn ceex(&mut self) -> CeexW<CexCtl1Spec> {
        CeexW::new(self, 5)
    }
    #[doc = "Bits 6:7 - Filter delay"]
    #[inline(always)]
    pub fn cefdly(&mut self) -> CefdlyW<CexCtl1Spec> {
        CefdlyW::new(self, 6)
    }
    #[doc = "Bits 8:9 - Power Mode"]
    #[inline(always)]
    pub fn cepwrmd(&mut self) -> CepwrmdW<CexCtl1Spec> {
        CepwrmdW::new(self, 8)
    }
    #[doc = "Bit 10 - Comparator On"]
    #[inline(always)]
    pub fn ceon(&mut self) -> CeonW<CexCtl1Spec> {
        CeonW::new(self, 10)
    }
    #[doc = "Bit 11 - This bit is valid of CEMRVS is set to 1"]
    #[inline(always)]
    pub fn cemrvl(&mut self) -> CemrvlW<CexCtl1Spec> {
        CemrvlW::new(self, 11)
    }
    #[doc = "Bit 12 - This bit defines if the comparator output selects between VREF0 or VREF1 if CERS = 00, 01, or 10."]
    #[inline(always)]
    pub fn cemrvs(&mut self) -> CemrvsW<CexCtl1Spec> {
        CemrvsW::new(self, 12)
    }
}
#[doc = "Comparator Control Register 1\n\nYou can [`read`](crate::Reg::read) this register and get [`cex_ctl1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cex_ctl1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CexCtl1Spec;
impl crate::RegisterSpec for CexCtl1Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`cex_ctl1::R`](R) reader structure"]
impl crate::Readable for CexCtl1Spec {}
#[doc = "`write(|w| ..)` method takes [`cex_ctl1::W`](W) writer structure"]
impl crate::Writable for CexCtl1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets CExCTL1 to value 0"]
impl crate::Resettable for CexCtl1Spec {
