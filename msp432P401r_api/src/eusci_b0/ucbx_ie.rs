...
pub type R = crate::R<UcbxIeSpec>;
#[doc = "Register `UCBxIE` writer"]
pub type W = crate::W<UcbxIeSpec>;
...
impl W {
    #[doc = "Bit 0 - Receive interrupt enable 0"]
    #[inline(always)]
    pub fn ucrxie0(&mut self) -> Ucrxie0W<UcbxIeSpec> {
        Ucrxie0W::new(self, 0)
    }
    #[doc = "Bit 1 - Transmit interrupt enable 0"]
    #[inline(always)]
    pub fn uctxie0(&mut self) -> Uctxie0W<UcbxIeSpec> {
        Uctxie0W::new(self, 1)
    }
    #[doc = "Bit 2 - START condition interrupt enable"]
    #[inline(always)]
    pub fn ucsttie(&mut self) -> UcsttieW<UcbxIeSpec> {
        UcsttieW::new(self, 2)
    }
    #[doc = "Bit 3 - STOP condition interrupt enable"]
    #[inline(always)]
    pub fn ucstpie(&mut self) -> UcstpieW<UcbxIeSpec> {
        UcstpieW::new(self, 3)
    }
    #[doc = "Bit 4 - Arbitration lost interrupt enable"]
    #[inline(always)]
    pub fn ucalie(&mut self) -> UcalieW<UcbxIeSpec> {
        UcalieW::new(self, 4)
    }
    #[doc = "Bit 5 - Not-acknowledge interrupt enable"]
    #[inline(always)]
    pub fn ucnackie(&mut self) -> UcnackieW<UcbxIeSpec> {
        UcnackieW::new(self, 5)
    }
    #[doc = "Bit 6 - Byte counter interrupt enable"]
    #[inline(always)]
    pub fn ucbcntie(&mut self) -> UcbcntieW<UcbxIeSpec> {
        UcbcntieW::new(self, 6)
    }
    #[doc = "Bit 7 - Clock low timeout interrupt enable"]
    #[inline(always)]
    pub fn uccltoie(&mut self) -> UccltoieW<UcbxIeSpec> {
        UccltoieW::new(self, 7)
    }
    #[doc = "Bit 8 - Receive interrupt enable 1"]
    #[inline(always)]
    pub fn ucrxie1(&mut self) -> Ucrxie1W<UcbxIeSpec> {
        Ucrxie1W::new(self, 8)
    }
    #[doc = "Bit 9 - Transmit interrupt enable 1"]
    #[inline(always)]
    pub fn uctxie1(&mut self) -> Uctxie1W<UcbxIeSpec> {
        Uctxie1W::new(self, 9)
    }
    #[doc = "Bit 10 - Receive interrupt enable 2"]
    #[inline(always)]
    pub fn ucrxie2(&mut self) -> Ucrxie2W<UcbxIeSpec> {
        Ucrxie2W::new(self, 10)
    }
    #[doc = "Bit 11 - Transmit interrupt enable 2"]
    #[inline(always)]
    pub fn uctxie2(&mut self) -> Uctxie2W<UcbxIeSpec> {
        Uctxie2W::new(self, 11)
    }
    #[doc = "Bit 12 - Receive interrupt enable 3"]
    #[inline(always)]
    pub fn ucrxie3(&mut self) -> Ucrxie3W<UcbxIeSpec> {
        Ucrxie3W::new(self, 12)
    }
    #[doc = "Bit 13 - Transmit interrupt enable 3"]
    #[inline(always)]
    pub fn uctxie3(&mut self) -> Uctxie3W<UcbxIeSpec> {
        Uctxie3W::new(self, 13)
    }
    #[doc = "Bit 14 - Bit position 9 interrupt enable"]
    #[inline(always)]
    pub fn ucbit9ie(&mut self) -> Ucbit9ieW<UcbxIeSpec> {
        Ucbit9ieW::new(self, 14)
    }
}
#[doc = "eUSCI_Bx Interrupt Enable Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ucbx_ie::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ucbx_ie::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct UcbxIeSpec;
impl crate::RegisterSpec for UcbxIeSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ucbx_ie::R`](R) reader structure"]
impl crate::Readable for UcbxIeSpec {}
#[doc = "`write(|w| ..)` method takes [`ucbx_ie::W`](W) writer structure"]
impl crate::Writable for UcbxIeSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCBxIE to value 0"]
impl crate::Resettable for UcbxIeSpec {
