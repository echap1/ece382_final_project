#[doc = "Register `UCBxCTLW1` reader"]
pub type R = crate::R<UcbxCtlw1Spec>;
#[doc = "Register `UCBxCTLW1` writer"]
pub type W = crate::W<UcbxCtlw1Spec>;
#[doc = "Deglitch time\n\nValue on reset: 3"]
...
impl UcastpR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Ucastp> {
        match self.bits {
            0 => Some(Ucastp::Ucastp0),
            1 => Some(Ucastp::Ucastp1),
            2 => Some(Ucastp::Ucastp2),
            _ => None,
        }
    }
...
pub type UcastpW<'a, REG> = crate::FieldWriter<'a, REG, 2, Ucastp>;
...
impl W {
    #[doc = "Bits 0:1 - Deglitch time"]
    #[inline(always)]
    pub fn ucglit(&mut self) -> UcglitW<UcbxCtlw1Spec> {
        UcglitW::new(self, 0)
    }
    #[doc = "Bits 2:3 - Automatic STOP condition generation"]
    #[inline(always)]
    pub fn ucastp(&mut self) -> UcastpW<UcbxCtlw1Spec> {
        UcastpW::new(self, 2)
    }
    #[doc = "Bit 4 - SW or HW ACK control"]
    #[inline(always)]
    pub fn ucswack(&mut self) -> UcswackW<UcbxCtlw1Spec> {
        UcswackW::new(self, 4)
    }
    #[doc = "Bit 5 - ACK all master bytes"]
    #[inline(always)]
    pub fn ucstpnack(&mut self) -> UcstpnackW<UcbxCtlw1Spec> {
        UcstpnackW::new(self, 5)
    }
    #[doc = "Bits 6:7 - Clock low timeout select"]
    #[inline(always)]
    pub fn ucclto(&mut self) -> UccltoW<UcbxCtlw1Spec> {
        UccltoW::new(self, 6)
    }
    #[doc = "Bit 8 - Early UCTXIFG0"]
    #[inline(always)]
    pub fn ucetxint(&mut self) -> UcetxintW<UcbxCtlw1Spec> {
        UcetxintW::new(self, 8)
    }
}
#[doc = "eUSCI_Bx Control Word Register 1\n\nYou can [`read`](crate::Reg::read) this register and get [`ucbx_ctlw1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ucbx_ctlw1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct UcbxCtlw1Spec;
impl crate::RegisterSpec for UcbxCtlw1Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ucbx_ctlw1::R`](R) reader structure"]
impl crate::Readable for UcbxCtlw1Spec {}
#[doc = "`write(|w| ..)` method takes [`ucbx_ctlw1::W`](W) writer structure"]
impl crate::Writable for UcbxCtlw1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCBxCTLW1 to value 0x03"]
impl crate::Resettable for UcbxCtlw1Spec {
