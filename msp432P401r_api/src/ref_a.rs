...
#[doc = "REFCTL0 (rw) register accessor: REF Control Register 0\n\nYou can [`read`](crate::Reg::read) this register and get [`refctl0::R`]. You can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`refctl0::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@refctl0`]
module"]
#[doc(alias = "REFCTL0")]
