...
pub type R = crate::R<FlctlProgramTimctlSpec>;
...
#[doc = "Program Timing Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`flctl_program_timctl::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FlctlProgramTimctlSpec;
impl crate::RegisterSpec for FlctlProgramTimctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flctl_program_timctl::R`](R) reader structure"]
impl crate::Readable for FlctlProgramTimctlSpec {}
