#[doc = "Register `FLCTL_BANK1_RDCTL` reader"]
pub type R = crate::R<FlctlBank1RdctlSpec>;
#[doc = "Register `FLCTL_BANK1_RDCTL` writer"]
pub type W = crate::W<FlctlBank1RdctlSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Flash read mode control setting for Bank 0"]
    #[inline(always)]
    pub fn rd_mode(&mut self) -> RdModeW<FlctlBank1RdctlSpec> {
        RdModeW::new(self, 0)
    }
    #[doc = "Bit 4 - Enables read buffering feature for instruction fetches to this Bank"]
    #[inline(always)]
    pub fn bufi(&mut self) -> BufiW<FlctlBank1RdctlSpec> {
        BufiW::new(self, 4)
    }
    #[doc = "Bit 5 - Enables read buffering feature for data reads to this Bank"]
    #[inline(always)]
    pub fn bufd(&mut self) -> BufdW<FlctlBank1RdctlSpec> {
        BufdW::new(self, 5)
    }
    #[doc = "Bits 12:15 - Number of wait states for read"]
    #[inline(always)]
    pub fn wait(&mut self) -> WaitW<FlctlBank1RdctlSpec> {
        WaitW::new(self, 12)
    }
}
#[doc = "Bank1 Read Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`flctl_bank1_rdctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`flctl_bank1_rdctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FlctlBank1RdctlSpec;
impl crate::RegisterSpec for FlctlBank1RdctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flctl_bank1_rdctl::R`](R) reader structure"]
impl crate::Readable for FlctlBank1RdctlSpec {}
#[doc = "`write(|w| ..)` method takes [`flctl_bank1_rdctl::W`](W) writer structure"]
impl crate::Writable for FlctlBank1RdctlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FLCTL_BANK1_RDCTL to value 0"]
impl crate::Resettable for FlctlBank1RdctlSpec {
