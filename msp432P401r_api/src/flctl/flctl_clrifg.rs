#[doc = "Register `FLCTL_CLRIFG` writer"]
pub type W = crate::W<FlctlClrifgSpec>;
...
impl W {
    ...
    #[inline(always)]
    pub fn rdbrst(&mut self) -> RdbrstW<FlctlClrifgSpec> {
        RdbrstW::new(self, 0)
    }
    #[doc = "Bit 1 - Write 1 clears the corresponding interrupt flag bit in the FLCTL_IFG"]
    #[inline(always)]
    pub fn avpre(&mut self) -> AvpreW<FlctlClrifgSpec> {
        AvpreW::new(self, 1)
    }
    #[doc = "Bit 2 - Write 1 clears the corresponding interrupt flag bit in the FLCTL_IFG"]
    #[inline(always)]
    pub fn avpst(&mut self) -> AvpstW<FlctlClrifgSpec> {
        AvpstW::new(self, 2)
    }
    #[doc = "Bit 3 - Write 1 clears the corresponding interrupt flag bit in the FLCTL_IFG"]
    #[inline(always)]
    pub fn prg(&mut self) -> PrgW<FlctlClrifgSpec> {
        PrgW::new(self, 3)
    }
    #[doc = "Bit 4 - Write 1 clears the corresponding interrupt flag bit in the FLCTL_IFG"]
    #[inline(always)]
    pub fn prgb(&mut self) -> PrgbW<FlctlClrifgSpec> {
        PrgbW::new(self, 4)
    }
    #[doc = "Bit 5 - Write 1 clears the corresponding interrupt flag bit in the FLCTL_IFG"]
    #[inline(always)]
    pub fn erase(&mut self) -> EraseW<FlctlClrifgSpec> {
        EraseW::new(self, 5)
    }
    #[doc = "Bit 8 - Write 1 clears the corresponding interrupt flag bit in the FLCTL_IFG"]
    #[inline(always)]
    pub fn bmrk(&mut self) -> BmrkW<FlctlClrifgSpec> {
        BmrkW::new(self, 8)
    }
    #[doc = "Bit 9 - Write 1 clears the corresponding interrupt flag bit in the FLCTL_IFG"]
    #[inline(always)]
    pub fn prg_err(&mut self) -> PrgErrW<FlctlClrifgSpec> {
        PrgErrW::new(self, 9)
    }
}
#[doc = "Clear Interrupt Flag Register\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`flctl_clrifg::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FlctlClrifgSpec;
impl crate::RegisterSpec for FlctlClrifgSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`flctl_clrifg::W`](W) writer structure"]
impl crate::Writable for FlctlClrifgSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FLCTL_CLRIFG to value 0"]
impl crate::Resettable for FlctlClrifgSpec {
