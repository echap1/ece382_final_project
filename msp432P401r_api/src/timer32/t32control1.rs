...
pub type R = crate::R<T32control1Spec>;
#[doc = "Register `T32CONTROL1` writer"]
pub type W = crate::W<T32control1Spec>;
...
impl W {
    #[doc = "Bit 0 - Selects one-shot or wrapping counter mode"]
    #[inline(always)]
    pub fn oneshot(&mut self) -> OneshotW<T32control1Spec> {
        OneshotW::new(self, 0)
    }
    #[doc = "Bit 1 - Selects 16 or 32 bit counter operation"]
    #[inline(always)]
    pub fn size(&mut self) -> SizeW<T32control1Spec> {
        SizeW::new(self, 1)
    }
    #[doc = "Bits 2:3 - Prescale bits"]
    #[inline(always)]
    pub fn prescale(&mut self) -> PrescaleW<T32control1Spec> {
        PrescaleW::new(self, 2)
    }
    #[doc = "Bit 5 - Interrupt enable bit"]
    #[inline(always)]
    pub fn ie(&mut self) -> IeW<T32control1Spec> {
        IeW::new(self, 5)
    }
    #[doc = "Bit 6 - Mode bit"]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<T32control1Spec> {
        ModeW::new(self, 6)
    }
    #[doc = "Bit 7 - Enable bit"]
    #[inline(always)]
    pub fn enable(&mut self) -> EnableW<T32control1Spec> {
        EnableW::new(self, 7)
    }
}
#[doc = "Timer 1 Timer Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`t32control1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`t32control1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct T32control1Spec;
impl crate::RegisterSpec for T32control1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`t32control1::R`](R) reader structure"]
impl crate::Readable for T32control1Spec {}
#[doc = "`write(|w| ..)` method takes [`t32control1::W`](W) writer structure"]
impl crate::Writable for T32control1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets T32CONTROL1 to value 0x20"]
impl crate::Resettable for T32control1Spec {
