...
pub mod aesadin;
#[doc = "AESADOUT (w) register accessor: AES Accelerator Data Out Register\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`aesadout::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@aesadout`]
module"]
#[doc(alias = "AESADOUT")]
