...
pub type R = crate::R<UcaxIfgSpec>;
#[doc = "Register `UCAxIFG` writer"]
pub type W = crate::W<UcaxIfgSpec>;
...
impl W {
    #[doc = "Bit 0 - Receive interrupt flag"]
    #[inline(always)]
    pub fn ucrxifg(&mut self) -> UcrxifgW<UcaxIfgSpec> {
        UcrxifgW::new(self, 0)
    }
    #[doc = "Bit 1 - Transmit interrupt flag"]
    #[inline(always)]
    pub fn uctxifg(&mut self) -> UctxifgW<UcaxIfgSpec> {
        UctxifgW::new(self, 1)
    }
    #[doc = "Bit 2 - Start bit interrupt flag"]
    #[inline(always)]
    pub fn ucsttifg(&mut self) -> UcsttifgW<UcaxIfgSpec> {
        UcsttifgW::new(self, 2)
    }
    #[doc = "Bit 3 - Transmit ready interrupt enable"]
    #[inline(always)]
    pub fn uctxcptifg(&mut self) -> UctxcptifgW<UcaxIfgSpec> {
        UctxcptifgW::new(self, 3)
    }
}
#[doc = "eUSCI_Ax Interrupt Flag Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ucax_ifg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ucax_ifg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct UcaxIfgSpec;
impl crate::RegisterSpec for UcaxIfgSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ucax_ifg::R`](R) reader structure"]
impl crate::Readable for UcaxIfgSpec {}
#[doc = "`write(|w| ..)` method takes [`ucax_ifg::W`](W) writer structure"]
impl crate::Writable for UcaxIfgSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCAxIFG to value 0x02"]
impl crate::Resettable for UcaxIfgSpec {
