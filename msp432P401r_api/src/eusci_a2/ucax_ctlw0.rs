...
pub type R = crate::R<UcaxCtlw0Spec>;
#[doc = "Register `UCAxCTLW0` writer"]
pub type W = crate::W<UcaxCtlw0Spec>;
...
impl UcsselR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Ucssel> {
        match self.bits {
            0 => Some(Ucssel::Ucssel0),
            1 => Some(Ucssel::Ucssel1),
            2 => Some(Ucssel::Ucssel2),
            _ => None,
        }
    }
    #[doc = "UCLK"]
...
pub type UcsselW<'a, REG> = crate::FieldWriter<'a, REG, 2, Ucssel>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "8-bit data"]
    #[inline(always)]
    pub fn uc7bit_0(self) -> &'a mut crate::W<REG> {
        self.variant(Uc7bit::Uc7bit0)
    }
    #[doc = "7-bit data"]
    #[inline(always)]
    pub fn uc7bit_1(self) -> &'a mut crate::W<REG> {
        self.variant(Uc7bit::Uc7bit1)
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Odd parity"]
    #[inline(always)]
    pub fn ucpar_0(self) -> &'a mut crate::W<REG> {
        self.variant(Ucpar::Ucpar0)
    }
    #[doc = "Even parity"]
    #[inline(always)]
    pub fn ucpar_1(self) -> &'a mut crate::W<REG> {
        self.variant(Ucpar::Ucpar1)
    }
}
#[doc = "Parity enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
impl W {
    #[doc = "Bit 0 - Software reset enable"]
    #[inline(always)]
    pub fn ucswrst(&mut self) -> UcswrstW<UcaxCtlw0Spec> {
        UcswrstW::new(self, 0)
    }
    #[doc = "Bit 1 - Transmit break"]
    #[inline(always)]
    pub fn uctxbrk(&mut self) -> UctxbrkW<UcaxCtlw0Spec> {
        UctxbrkW::new(self, 1)
    }
    #[doc = "Bit 2 - Transmit address"]
    #[inline(always)]
    pub fn uctxaddr(&mut self) -> UctxaddrW<UcaxCtlw0Spec> {
        UctxaddrW::new(self, 2)
    }
    #[doc = "Bit 3 - Dormant"]
    #[inline(always)]
    pub fn ucdorm(&mut self) -> UcdormW<UcaxCtlw0Spec> {
        UcdormW::new(self, 3)
    }
    #[doc = "Bit 4 - Receive break character interrupt enable"]
    #[inline(always)]
    pub fn ucbrkie(&mut self) -> UcbrkieW<UcaxCtlw0Spec> {
        UcbrkieW::new(self, 4)
    }
    #[doc = "Bit 5 - Receive erroneous-character interrupt enable"]
    #[inline(always)]
    pub fn ucrxeie(&mut self) -> UcrxeieW<UcaxCtlw0Spec> {
        UcrxeieW::new(self, 5)
    }
    #[doc = "Bits 6:7 - eUSCI_A clock source select"]
    #[inline(always)]
    pub fn ucssel(&mut self) -> UcsselW<UcaxCtlw0Spec> {
        UcsselW::new(self, 6)
    }
    #[doc = "Bit 8 - Synchronous mode enable"]
    #[inline(always)]
    pub fn ucsync(&mut self) -> UcsyncW<UcaxCtlw0Spec> {
        UcsyncW::new(self, 8)
    }
    #[doc = "Bits 9:10 - eUSCI_A mode"]
    #[inline(always)]
    pub fn ucmode(&mut self) -> UcmodeW<UcaxCtlw0Spec> {
        UcmodeW::new(self, 9)
    }
    #[doc = "Bit 11 - Stop bit select"]
    #[inline(always)]
    pub fn ucspb(&mut self) -> UcspbW<UcaxCtlw0Spec> {
        UcspbW::new(self, 11)
    }
    #[doc = "Bit 12 - Character length"]
    #[inline(always)]
    pub fn uc7bit(&mut self) -> Uc7bitW<UcaxCtlw0Spec> {
        Uc7bitW::new(self, 12)
    }
    #[doc = "Bit 13 - MSB first select"]
    #[inline(always)]
    pub fn ucmsb(&mut self) -> UcmsbW<UcaxCtlw0Spec> {
        UcmsbW::new(self, 13)
    }
    #[doc = "Bit 14 - Parity select"]
    #[inline(always)]
    pub fn ucpar(&mut self) -> UcparW<UcaxCtlw0Spec> {
        UcparW::new(self, 14)
    }
    #[doc = "Bit 15 - Parity enable"]
    #[inline(always)]
    pub fn ucpen(&mut self) -> UcpenW<UcaxCtlw0Spec> {
        UcpenW::new(self, 15)
    }
}
#[doc = "eUSCI_Ax Control Word Register 0\n\nYou can [`read`](crate::Reg::read) this register and get [`ucax_ctlw0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ucax_ctlw0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct UcaxCtlw0Spec;
impl crate::RegisterSpec for UcaxCtlw0Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ucax_ctlw0::R`](R) reader structure"]
impl crate::Readable for UcaxCtlw0Spec {}
#[doc = "`write(|w| ..)` method takes [`ucax_ctlw0::W`](W) writer structure"]
impl crate::Writable for UcaxCtlw0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCAxCTLW0 to value 0x01"]
impl crate::Resettable for UcaxCtlw0Spec {
