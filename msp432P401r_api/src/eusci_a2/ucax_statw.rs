...
pub type R = crate::R<UcaxStatwSpec>;
#[doc = "Register `UCAxSTATW` writer"]
pub type W = crate::W<UcaxStatwSpec>;
#[doc = "eUSCI_A busy\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum UcbusyEnumRead {
    #[doc = "0: eUSCI_A inactive"]
    Ucbusy0 = 0,
    #[doc = "1: eUSCI_A transmitting or receiving"]
    Ucbusy1 = 1,
}
impl From<UcbusyEnumRead> for bool {
    #[inline(always)]
    fn from(variant: UcbusyEnumRead) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `UCBUSY` reader - eUSCI_A busy"]
pub type UcbusyR = crate::BitReader<UcbusyEnumRead>;
impl UcbusyR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> UcbusyEnumRead {
        match self.bits {
            false => UcbusyEnumRead::Ucbusy0,
            true => UcbusyEnumRead::Ucbusy1,
        }
    }
    #[doc = "eUSCI_A inactive"]
    #[inline(always)]
    pub fn is_ucbusy_0(&self) -> bool {
        *self == UcbusyEnumRead::Ucbusy0
    }
    #[doc = "eUSCI_A transmitting or receiving"]
    #[inline(always)]
    pub fn is_ucbusy_1(&self) -> bool {
        *self == UcbusyEnumRead::Ucbusy1
    }
}
#[doc = "Field `UCADDR_UCIDLE` reader - Address received / Idle line detected"]
pub type UcaddrUcidleR = crate::BitReader;
#[doc = "Field `UCADDR_UCIDLE` writer - Address received / Idle line detected"]
pub type UcaddrUcidleW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    #[doc = "Bit 1 - Address received / Idle line detected"]
    #[inline(always)]
    pub fn ucaddr_ucidle(&mut self) -> UcaddrUcidleW<UcaxStatwSpec> {
        UcaddrUcidleW::new(self, 1)
    }
    #[doc = "Bit 2 - Receive error flag"]
    #[inline(always)]
    pub fn ucrxerr(&mut self) -> UcrxerrW<UcaxStatwSpec> {
        UcrxerrW::new(self, 2)
    }
    #[doc = "Bit 3 - Break detect flag"]
    #[inline(always)]
    pub fn ucbrk(&mut self) -> UcbrkW<UcaxStatwSpec> {
        UcbrkW::new(self, 3)
    }
    #[doc = "Bit 4 - Parity error flag. When UCPEN = 0, UCPE is read as 0. UCPE is cleared when UCAxRXBUF is read."]
    #[inline(always)]
    pub fn ucpe(&mut self) -> UcpeW<UcaxStatwSpec> {
        UcpeW::new(self, 4)
    }
    #[doc = "Bit 5 - Overrun error flag"]
    #[inline(always)]
    pub fn ucoe(&mut self) -> UcoeW<UcaxStatwSpec> {
        UcoeW::new(self, 5)
    }
    #[doc = "Bit 6 - Framing error flag"]
    #[inline(always)]
    pub fn ucfe(&mut self) -> UcfeW<UcaxStatwSpec> {
        UcfeW::new(self, 6)
    }
    #[doc = "Bit 7 - Listen enable"]
    #[inline(always)]
    pub fn uclisten(&mut self) -> UclistenW<UcaxStatwSpec> {
        UclistenW::new(self, 7)
    }
}
#[doc = "eUSCI_Ax Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ucax_statw::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ucax_statw::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct UcaxStatwSpec;
impl crate::RegisterSpec for UcaxStatwSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ucax_statw::R`](R) reader structure"]
impl crate::Readable for UcaxStatwSpec {}
#[doc = "`write(|w| ..)` method takes [`ucax_statw::W`](W) writer structure"]
impl crate::Writable for UcaxStatwSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCAxSTATW to value 0"]
impl crate::Resettable for UcaxStatwSpec {
