#[doc = "Register `UCAxABCTL` reader"]
pub type R = crate::R<UcaxAbctlSpec>;
#[doc = "Register `UCAxABCTL` writer"]
pub type W = crate::W<UcaxAbctlSpec>;
...
impl W {
    #[doc = "Bit 0 - Automatic baud-rate detect enable"]
    #[inline(always)]
    pub fn ucabden(&mut self) -> UcabdenW<UcaxAbctlSpec> {
        UcabdenW::new(self, 0)
    }
    #[doc = "Bit 2 - Break time out error"]
    #[inline(always)]
    pub fn ucbtoe(&mut self) -> UcbtoeW<UcaxAbctlSpec> {
        UcbtoeW::new(self, 2)
    }
    #[doc = "Bit 3 - Synch field time out error"]
    #[inline(always)]
    pub fn ucstoe(&mut self) -> UcstoeW<UcaxAbctlSpec> {
        UcstoeW::new(self, 3)
    }
    #[doc = "Bits 4:5 - Break/synch delimiter length"]
    #[inline(always)]
    pub fn ucdelim(&mut self) -> UcdelimW<UcaxAbctlSpec> {
        UcdelimW::new(self, 4)
    }
}
#[doc = "eUSCI_Ax Auto Baud Rate Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ucax_abctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ucax_abctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct UcaxAbctlSpec;
impl crate::RegisterSpec for UcaxAbctlSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ucax_abctl::R`](R) reader structure"]
impl crate::Readable for UcaxAbctlSpec {}
#[doc = "`write(|w| ..)` method takes [`ucax_abctl::W`](W) writer structure"]
impl crate::Writable for UcaxAbctlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCAxABCTL to value 0"]
impl crate::Resettable for UcaxAbctlSpec {
