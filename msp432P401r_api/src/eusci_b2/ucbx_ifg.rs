...
pub type R = crate::R<UcbxIfgSpec>;
#[doc = "Register `UCBxIFG` writer"]
pub type W = crate::W<UcbxIfgSpec>;
...
impl W {
    #[doc = "Bit 0 - eUSCI_B receive interrupt flag 0"]
    #[inline(always)]
    pub fn ucrxifg0(&mut self) -> Ucrxifg0W<UcbxIfgSpec> {
        Ucrxifg0W::new(self, 0)
    }
    #[doc = "Bit 1 - eUSCI_B transmit interrupt flag 0"]
    #[inline(always)]
    pub fn uctxifg0(&mut self) -> Uctxifg0W<UcbxIfgSpec> {
        Uctxifg0W::new(self, 1)
    }
    #[doc = "Bit 2 - START condition interrupt flag"]
    #[inline(always)]
    pub fn ucsttifg(&mut self) -> UcsttifgW<UcbxIfgSpec> {
        UcsttifgW::new(self, 2)
    }
    #[doc = "Bit 3 - STOP condition interrupt flag"]
    #[inline(always)]
    pub fn ucstpifg(&mut self) -> UcstpifgW<UcbxIfgSpec> {
        UcstpifgW::new(self, 3)
    }
    #[doc = "Bit 4 - Arbitration lost interrupt flag"]
    #[inline(always)]
    pub fn ucalifg(&mut self) -> UcalifgW<UcbxIfgSpec> {
        UcalifgW::new(self, 4)
    }
    #[doc = "Bit 5 - Not-acknowledge received interrupt flag"]
    #[inline(always)]
    pub fn ucnackifg(&mut self) -> UcnackifgW<UcbxIfgSpec> {
        UcnackifgW::new(self, 5)
    }
    #[doc = "Bit 6 - Byte counter interrupt flag"]
    #[inline(always)]
    pub fn ucbcntifg(&mut self) -> UcbcntifgW<UcbxIfgSpec> {
        UcbcntifgW::new(self, 6)
    }
    #[doc = "Bit 7 - Clock low timeout interrupt flag"]
    #[inline(always)]
    pub fn uccltoifg(&mut self) -> UccltoifgW<UcbxIfgSpec> {
        UccltoifgW::new(self, 7)
    }
    #[doc = "Bit 8 - eUSCI_B receive interrupt flag 1"]
    #[inline(always)]
    pub fn ucrxifg1(&mut self) -> Ucrxifg1W<UcbxIfgSpec> {
        Ucrxifg1W::new(self, 8)
    }
    #[doc = "Bit 9 - eUSCI_B transmit interrupt flag 1"]
    #[inline(always)]
    pub fn uctxifg1(&mut self) -> Uctxifg1W<UcbxIfgSpec> {
        Uctxifg1W::new(self, 9)
    }
    #[doc = "Bit 10 - eUSCI_B receive interrupt flag 2"]
    #[inline(always)]
    pub fn ucrxifg2(&mut self) -> Ucrxifg2W<UcbxIfgSpec> {
        Ucrxifg2W::new(self, 10)
    }
    #[doc = "Bit 11 - eUSCI_B transmit interrupt flag 2"]
    #[inline(always)]
    pub fn uctxifg2(&mut self) -> Uctxifg2W<UcbxIfgSpec> {
        Uctxifg2W::new(self, 11)
    }
    #[doc = "Bit 12 - eUSCI_B receive interrupt flag 3"]
    #[inline(always)]
    pub fn ucrxifg3(&mut self) -> Ucrxifg3W<UcbxIfgSpec> {
        Ucrxifg3W::new(self, 12)
    }
    #[doc = "Bit 13 - eUSCI_B transmit interrupt flag 3"]
    #[inline(always)]
    pub fn uctxifg3(&mut self) -> Uctxifg3W<UcbxIfgSpec> {
        Uctxifg3W::new(self, 13)
    }
    #[doc = "Bit 14 - Bit position 9 interrupt flag"]
    #[inline(always)]
    pub fn ucbit9ifg(&mut self) -> Ucbit9ifgW<UcbxIfgSpec> {
        Ucbit9ifgW::new(self, 14)
    }
}
#[doc = "eUSCI_Bx Interrupt Flag Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ucbx_ifg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ucbx_ifg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct UcbxIfgSpec;
impl crate::RegisterSpec for UcbxIfgSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ucbx_ifg::R`](R) reader structure"]
impl crate::Readable for UcbxIfgSpec {}
#[doc = "`write(|w| ..)` method takes [`ucbx_ifg::W`](W) writer structure"]
impl crate::Writable for UcbxIfgSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UCBxIFG to value 0x02"]
impl crate::Resettable for UcbxIfgSpec {
